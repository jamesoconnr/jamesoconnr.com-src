...
import { ref } from 'vue';
const props = defineProps(['title', 'date', 'content', 'num'])
const HTMLcontent = marked.parse(props.content)
let postVis = ref(false)
let rotation = 0
const togglePost = () =>{
    const arrow = document.querySelector('#' + props.num)
